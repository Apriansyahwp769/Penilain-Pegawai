...
class ProfileController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            // View untuk HRD (bisa pakai view ketua-divisi atau buat khusus HRD)
            return view('hrd.profile.index', compact('user'));
            
        } catch (\Exception $e) {
            Log::error("HRD Profile Index Error: " . $e->getMessage());
            return back()->with('error', 'Gagal memuat halaman profile.');
        }
    }

    /**
     * Update profile for HRD
     */
    public function update(Request $request)
    {
        try {
            ...
            Log::error("HRD Profile Update Error: " . $e->getMessage());
